...
async def initiate_transfer(request: TransferRequest) -> TransferResponse:
    ...
    try:
        ...
        try:
            ...
            return TransferResponse(summary=fallback, id=rec_id, room_name=request.room_name, agent_a_identity=request.agent_a_identity, briefing_room_name=briefing_room_name)
    except Exception as e:
