...
def list_transfers(room_name: Optional[str] = None, limit: int = 100) -> List[Dict[str, Any]]:
    # Optimize: Exclude large 'call_context' field from list query to save I/O
    ...
    # We must return dictionaries with 'call_context': None to satisfy TransferRecord contract
    return [{**dict(zip(keys, r)), "call_context": None} for r in rows]
